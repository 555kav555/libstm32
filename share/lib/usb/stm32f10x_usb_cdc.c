...
static USB_CDC_lineCoding_t lineCoding={9600,0,0,8};
	...
	case USB_REQUEST_TYPE_CLASS:{
		if(USB_control.request.bmRequestType.Dir){
			...
			case USB_CDC_REQUEST_GET_LINE_CODING:
				USB_ctl_inData(0,&USB_control,(const uint8_t*)&lineCoding,sizeof(lineCoding));
				break;
			default:
				break;
			}
			...
			case USB_CDC_REQUEST_SET_LINE_CODING:
				USB_ctl_outData(0,&USB_control,(uint8_t*)&lineCoding,sizeof(lineCoding));
				break;
