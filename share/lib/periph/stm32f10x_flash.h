...
STM32DRV_API void FLASH_SetLatency(uint32_t FLASH_Latency);
STM32DRV_API void FLASH_HalfCycleAccessCmd(uint32_t FLASH_HalfCycleAccess);
STM32DRV_API void FLASH_PrefetchBufferCmd(uint32_t FLASH_PrefetchBuffer);
STM32DRV_API void FLASH_Unlock(void);
STM32DRV_API void FLASH_Lock(void);
STM32DRV_API FLASH_Status FLASH_ErasePage(uint32_t Page_Address);
STM32DRV_API FLASH_Status FLASH_EraseAllPages(void);
STM32DRV_API FLASH_Status FLASH_EraseOptionBytes(void);
STM32DRV_API FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data);
STM32DRV_API FLASH_Status FLASH_ProgramHalfWord(uint32_t Address, uint16_t Data);
STM32DRV_API FLASH_Status FLASH_ProgramOptionByteData(uint32_t Address, uint8_t Data);
STM32DRV_API FLASH_Status FLASH_EnableWriteProtection(uint32_t FLASH_Pages);
STM32DRV_API FLASH_Status FLASH_ReadOutProtection(FunctionalState NewState);
STM32DRV_API FLASH_Status FLASH_UserOptionByteConfig(uint16_t OB_IWDG, uint16_t OB_STOP, uint16_t OB_STDBY);
STM32DRV_API uint32_t FLASH_GetUserOptionByte(void);
STM32DRV_API uint32_t FLASH_GetWriteProtectionOptionByte(void);
STM32DRV_API FlagStatus FLASH_GetReadOutProtectionStatus(void);
STM32DRV_API FlagStatus FLASH_GetPrefetchBufferStatus(void);
STM32DRV_API void FLASH_ITConfig(uint32_t FLASH_IT, FunctionalState NewState);
STM32DRV_API FlagStatus FLASH_GetFlagStatus(uint32_t FLASH_FLAG);
STM32DRV_API void FLASH_ClearFlag(uint32_t FLASH_FLAG);
STM32DRV_API FLASH_Status FLASH_GetStatus(void);
STM32DRV_API FLASH_Status FLASH_WaitForLastOperation(uint32_t Timeout);

/*------------ New function used for all STM32F10x devices -----*/
STM32DRV_API void FLASH_UnlockBank1(void);
STM32DRV_API void FLASH_LockBank1(void);
STM32DRV_API FLASH_Status FLASH_EraseAllBank1Pages(void);
STM32DRV_API FLASH_Status FLASH_GetBank1Status(void);
STM32DRV_API FLASH_Status FLASH_WaitForLastBank1Operation(uint32_t Timeout);

#ifdef STM32F10X_XL
/*---- New Functions used only with STM32F10x_XL density devices -----*/
STM32DRV_API void FLASH_UnlockBank2(void);
STM32DRV_API void FLASH_LockBank2(void);
STM32DRV_API FLASH_Status FLASH_EraseAllBank2Pages(void);
STM32DRV_API FLASH_Status FLASH_GetBank2Status(void);
STM32DRV_API FLASH_Status FLASH_WaitForLastBank2Operation(uint32_t Timeout);
STM32DRV_API FLASH_Status FLASH_BootConfig(uint16_t FLASH_BOOT);
#endif
